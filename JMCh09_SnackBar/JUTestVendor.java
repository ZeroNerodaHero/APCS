...
public class JUTestVendor
{
    ...
    public void testVendorConstructor()
    {
        ...
        System.out.println("here"+Vendor.getTotalSales());
    ...
    public void testmakeSaleDepositToSmall()
    {
        ...
        if (!result)
        {
            System.out.println("niiiiiichhhan");

            System.out.println(machine1.getDeposit());
            assertEquals(0, machine1.getDeposit());
            System.out.println((ITEM_COST-5) + ' ' + machine1.getChange());
