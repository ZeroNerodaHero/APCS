...
public class PollDisplayPanel extends JPanel
{
    ...
    private void drawPieChart( Graphics g, int x, int y, int r )
    {
        ...
        if ( total > 0 )
        {
            ...
            // drawSector( g, x, y, r, 0, 120 );
            // System.out.println("count1 " + count1 + " " + fromDegree + " to "
            // + degrees+'\n');
                fromDegree = degrees;
            }
            ...
            if(count2 != 0) {
                drawSector( g, x, y, r, fromDegree, degrees );
            // drawSector( g, x, y, r, 120,120 );
            // System.out.println("count2 " + count2 + " "+fromDegree + " to " +
            // degrees+'\n');
            ...
            // drawSector( g, x, y, r, 240, 120 );
            // System.out.println("count3 " + count3 + " "+fromDegree + " to " +
            // degrees+'\n');
            }
        }
        else
    ...
    {
        System.out.println("out "+(int)( ((double) count/(double) total)*360 ));
        System.out.println("in "+(int)( ((double) count*360/(double) total) ));
        double rate = (double) count/total;
        int deg = (int)(rate * 360 + 0.5);
        return deg;
    }
